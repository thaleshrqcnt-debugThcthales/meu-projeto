  ...
  return (
    <main className="exhibition-page">
      ...
      <div id="exhibition-content" className="exhibition-layout">
        <div className="exhibition-image"><img src={bp + artifact.image} alt={artifact.imageAlt}/></div>
        <section className="exhibition-content">
          ...
          {artifact.audio ? <div className="audio-block"><span>{artifact.slug === "zunidor" ? "Ouça a audiodescrição e o som do zunidor" : "Ouça a audiodescrição"}</span><audio controls preload="metadata"><source src={bp + artifact.audio} type="audio/mpeg"/></audio></div> : null}
